...
def main():
    ...
    subprocess.run(["cmake", "--build", str(build), "--target", "display_simulator", "display_port_test", "display_connection_adapter_test", "display_status_adapter_test", "-j", "4"], check=True)
