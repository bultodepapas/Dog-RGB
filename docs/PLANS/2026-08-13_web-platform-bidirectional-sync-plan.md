...
**Still open:** a deliberately disposable hosted capacity/concurrency/network run, retention activation prerequisites, and the remaining operational drills. Phase 1 is not complete while these items remain.
