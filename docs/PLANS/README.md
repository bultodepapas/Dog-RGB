...
| [Display visual identity subplan — 2026-09-12](2026-09-12_display-visual-identity.md) | **VIS-1a/1b + VIS-2 implemented in software; next VIS-3 four pages/physical QR**. [Baseline](../baselines/display-vis2-2026-09-12.md); [28 investigations](../display-github-research-2026-09-12.md). Then components and measured motion; no new flash |
