...
| [Display visual identity subplan — 2026-09-12](2026-09-12_display-visual-identity.md) | **VIS-1a QR implemented/host-verified; next VIS-1b layouts**. [Baseline](../baselines/display-vis1a-2026-09-12.md); [28 investigations](../display-github-research-2026-09-12.md). Then persistence, four pages, components and measured motion; no new flash |
