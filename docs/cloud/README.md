# Optional cloud Phase 0 documentation

**Status:** Architecture/evidence work only. Dog-RGB has no deployed website, Supabase schema/functions, account system, or firmware cloud sync.
