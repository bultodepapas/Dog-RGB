...
Classic XIAO remains active while a Waveshare ESP32-S3-LCD-1.69 No Touch variant is developed with one shared firmware core and separate board profiles. I0 profiles and stage-0 diagnostics, the I1 LED bench target and the I2 normal-core GPS/LED target are implemented in software; the physical revision, boot validation and LCD UI remain unconfirmed/pending. The [incremental Display plan](PLANS/2026-09-12_display-incremental-delivery.md) is the execution authority, with [I2 software evidence](baselines/display-i2-2026-09-12.md); hardware/visual research is supporting material.
