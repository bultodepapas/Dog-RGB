...
| [WLED lessons and implementation plan](analisis-wled-y-plan-implementacion.md) | Phase 0 executed; later phases proposed, Spanish | Current-limiting, effect-registry, palette, segment, preset, and web-asset roadmap |
