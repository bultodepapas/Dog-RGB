...
Last code-alignment review: **2026-08-12** against the active firmware in [`Platformio/Dog-RGB`](../Platformio/Dog-RGB/).
...
| [WLED lessons and implementation plan](analisis-wled-y-plan-implementacion.md) | Phases 0 and 1 executed; later phases proposed, Spanish | Current-limiting, effect-registry, palette, segment, preset, and web-asset roadmap |
