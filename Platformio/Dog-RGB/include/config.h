...
static const bool LED_DEBUG_BRIGHTNESS_ENABLED = true; // Diagnostic: override runtime brightness.
static const uint8_t LED_DEBUG_BRIGHTNESS = 30; // Low-brightness debug value.
static const bool DEBUG_AP_ONLY_MINIMAL = true; // Diagnostic: boot only AP + portal, no GPS/LED/BLE/STA.
