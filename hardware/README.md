...
- [Implemented I0 board profiles and diagnostics](../Platformio/Dog-RGB/docs/boards.md) — candidate V2 SYS_EN power retention, backlight off, USB/memory reporting and experimental build targets; physical acceptance pending.
